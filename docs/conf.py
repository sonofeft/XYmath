...
# -*- coding: utf-8 -*-
#
# XYmath documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'xymath','_version.py')
...
MOCK_MODULES = ['scipy', 'numexpr', 'matplotlib', 'numpy']
...
latex_documents = [
  (master_doc, 'XYmath.tex', u'XYmath Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'XYmath Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'XYmath', u'XYmath Documentation',
   author, 'XYmath', 'One line description of project.',
   'Miscellaneous'),
]
